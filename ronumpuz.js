/*
Date: April 30, 2023
Coder: Lin Htet Aung(MIIT)
Program name: ROtate NUMbers PUZzle(ronumpuz)
Description : We get 4x4 board and to rearrange from number 1 to 16, 
---the method to solve is by moving and rotating the select box which is 2x2 size, you can rotate left(anti-clockwise) or right(clockwise)
---By Algorithm, there are three stages to solve this puzzle,
---First Stage is to arrange numbers untill remain last two rows,
---Second Stage is to arrange numbers untill remain last two columns,
---Third Stage is the heart of the Algorithm, A formula to solve any variation of this puzzle...You will understand once you give it a try.
***I did't find any difficulties coding this challenge, maybe because I can solve it manually? 
### Anyway if you found this interesting , I am happy to provide you the answer.

Fun Fact: This program has originally 420 lines of codes without This comment Message.
*/
var rows = 4, cols = 4;
var board = [
						[ 1, 2, 3, 4],
...
function main(){
	...
	for(let n=0; n<100; n++){
		...
		board = rotateSquare(board, random, 1, 'clockwise');
		steps_count--;
	}
